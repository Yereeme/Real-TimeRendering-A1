...
//define a pipeline vertex unput that take data from one binding (loc in gpu memory)
//2 attribute stream assemble it (binding)
// loc 0 is made of 3 vectors of 32 bit floating point values; and loc 1 is made of 4 vec of 8 bit unsigned int val
